...
@section('content')
    <main class="my-5 text-center">
        <div class="container flex justify-center items-center mx-auto border-b-2 py-4 border-gray-200">
            <img src="https://lwfiles.mycourse.app/6368e5089f20781a7e4f1805-public/2c162927114072f9ebbf04043a593fb9.png"
                alt="Laravel Framework" width="200" style="display: block; margin: auto;">
